...
class Visualiser(object):
    ...
    def __call__(self, fn):
        ...
        def wrapper(*args, **kwargs):
            ...
            (signature_args_string, label_args_string) = self.extract_arg_strings(
                *args, **kwargs
            )
            ...
            caller_func_kwargs = OrderedDict(sorted(caller_func_kwargs.items()))

            (
                caller_func_args_string,
                caller_func_label_args_string,
            ) = self.extract_arg_strings(**caller_func_kwargs)
            ...
            self.edges.append(f'"{caller_func_signature}" -> "{function_signature}"')
            ...
            if self.node_properties_kwargs:
                node_string += ", " + ", ".join(
                    [
                        f'{key}="{value}"'
                        for key, value in self.node_properties_kwargs.items()
                    ]
                )
